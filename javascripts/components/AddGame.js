...
var AddGame = React.createClass({
  ...
  submitForm: function(e) {
    if(this.state.linkState == "success" && this.state.nameState == "success" && this.state.descriptionState == "success" && this.state.images.length > 0 && this.state.images.length <= 6) {
